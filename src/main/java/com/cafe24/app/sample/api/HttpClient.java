package com.cafe24.app.sample.api;

import com.cafe24.app.sample.api.request.Cafe24Request;
import com.cafe24.app.sample.utils.Commons;
    ...
    protected String excute(Cafe24Request request) {
        ...
        try {
            ...
            for (Map.Entry<String, Object> header : request.headers().entrySet()) {
                log.info("header.getKey() : {}", header.getKey());
